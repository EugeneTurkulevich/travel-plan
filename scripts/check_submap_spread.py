...
# (острів, гірський масив). Це рішення про КОНКРЕТНЕ місце конкретної
# поїздки — дані, не метод, тому живе поруч із route_state.json, а не в
# коді. Формат: {label: пояснення}. Файлу може не бути — тоді просто {}.
ALLOW_FILE = CTX.trip_dir / "submap_allow.json"
ALLOW: dict[str, str] = CTX.read_json(ALLOW_FILE, default={})
